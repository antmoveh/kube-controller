...
// +kubebuilder:webhook:path=/mutate-custom-unit-crd-com-v1-unit,mutating=true,failurePolicy=fail,groups=custom.unit.crd.com,resources=units,verbs=create;update,versions=v1,name=munit.kb.io
...
func (r *Unit) Default() {
	...
	labelMap["app"] = r.Name
	r.Spec.Selector = &metav1.LabelSelector{MatchLabels: labelMap}
...
// +kubebuilder:webhook:verbs=create;update,path=/validate-custom-unit-crd-com-v1-unit,mutating=false,failurePolicy=fail,groups=custom.unit.crd.com,resources=units,versions=v1,name=vunit.kb.io
